...
'''
    Question 2: Port your DQN code to the frogger-v1 environment where the 
    agent needs to reach a specified goal position while moving both horizontally 
    and vertically, and facing bidirectional traffic. 
    You should extend your code by first implementing Double DQN.  
    Then, improve upon DDQN by implementing any of the other extensions 
    discussed in class, or any other technique that you see fit. 
    Please see the project descriprtion for more details.   
''' 
